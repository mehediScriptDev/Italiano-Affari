    ...
    <>
      ...
      >
        <div className="mt-3 w-100 d-flex flex-column">
          ...
          <Grid container className="" justifyContent="center" spacing={2}>
              ...
              >
                <div>
                  ...
                  <Button
                    ...
                    color={"secondary"}
                    sx={{ mt: 2 }}
                    onClick={(e) => handleAssetButtonClick()}
                  >
                    Mostra Assets
                  </Button>
            ...
            <Grid size={{ xs: 12, sm: 6, lg: 4 }}>
              <ChartPreview
                ...
                icon={
                  <AttachMoney style={{ color: "black", fontSize: "24px" }} />
                }
                obj={earningsPreview}
            ...
            <Grid size={{ xs: 12, sm: 6, lg: 4 }}>
              ...
              >
                ...
                <Typography>
                  Valore della rete:{" "}
                  <span className="price">{networkInfo.earnings}€</span>
                </Typography>
              </Box>
            </Grid>
          </Grid>
