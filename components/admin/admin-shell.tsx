    ...
    <>
      ...
      >
        ...
        <div
          ...
          onClick={handleOpen}
        >
          <Avatar sx={{ width: 34, height: 34, fontSize: 14, bgcolor: "#12715b" }}>A</Avatar>
          <div className="overflow-hidden whitespace-nowrap">
            <div className="text-sm font-semibold text-white">Amministratore</div>
            <div className="text-xs text-white/45 truncate">admin</div>
          </div>
        </div>
      ...
      >
        <div className="flex items-center gap-3 px-4 py-3.5 mb-1">
          <Avatar sx={{ width: 36, height: 36, bgcolor: "#12715b", fontSize: 14 }}>A</Avatar>
          <div>
            <p className="text-sm font-semibold m-0 leading-tight">Amministratore</p>
            <p className="text-xs text-slate-500 m-0 mt-0.5">Admin Panel</p>
          </div>
        </div>
