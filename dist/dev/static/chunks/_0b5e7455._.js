...
"[project]/components/dashboard/agent-management.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AgentManagement() {
    ...
    const [subAgents, setSubAgents] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const formatAgentTree = (agent)=>({
            id: agent.id,
            name: agent.name,
            email: agent.email,
            orders: agent.orders,
            date: agent.date,
            subagents: agent.subagents?.map(formatAgentTree) ?? []
        });
    const flattenSubAgents = (list)=>{
        let result = [];
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AgentManagement.useEffect": ()=>{
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$partners$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchSubAgents"])().then({
                "AgentManagement.useEffect": (response)=>{
            ...
            }["AgentManagement.useEffect"]).catch({
                "AgentManagement.useEffect": ()=>setLoading(false)
            }["AgentManagement.useEffect"]);
        }
    }["AgentManagement.useEffect"], []);
    const columns = [
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            const payload = {
                ...
                parent_id: formData.parent === -1 ? null : Number(formData.parent)
            };
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$partners$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["inviteSubAgent"])(payload);
            if (response.status === 200) (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$notifications$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["showToast"])("Invito inviato con successo!", "success");
            setOpenModal(false);
        } catch (error) {
            const err = error;
            if (err.response?.status === 404) (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$notifications$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["showToast"])("L'utente non è registrato.", "error");
            else if (err.response?.status === 409) (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$notifications$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["showToast"])("L'utente è già in una rete.", "error");
            else (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$notifications$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["showToast"])("Errore durante l'invito. Riprova.", "warning");
        }
    };
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                                        ...
                                        children: "Gestione Agenti"
                                    }, void 0, false, {
                                        fileName: "[project]/components/dashboard/agent-management.tsx",
                                        lineNumber: 87,
                                        columnNumber: 13
                                    }, this),
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        className: "page-subtitle",
                                        children: "La tua rete di partner"
                                    }, void 0, false, {
                                        fileName: "[project]/components/dashboard/agent-management.tsx",
                                        lineNumber: 88,
                                        columnNumber: 13
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Select$2f$Select$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Select$3e$__["Select"], {
                                                    ...
                                                    children: [
                                                        ...
                                                        loading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$MenuItem$2f$MenuItem$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__MenuItem$3e$__["MenuItem"], {
                                                            ...
                                                            lineNumber: 113,
                                                            columnNumber: 30
                                                        }, this) : subAgents.map((a)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$MenuItem$2f$MenuItem$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__MenuItem$3e$__["MenuItem"], {
                                                                value: a.id,
                                                                children: a.name
                                                            }, a.id, false, {
                                                                fileName: "[project]/components/dashboard/agent-management.tsx",
...
_s(AgentManagement, "KyuV/P0m1DFmvr+beroj2QD4F1Y=", false, function() {
    return [
...
_c = AgentManagement;
var _c;
__turbopack_context__.k.register(_c, "AgentManagement");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_0b5e7455._.js.map