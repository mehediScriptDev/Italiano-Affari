...
"[project]/components/user/sign-in.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function SignIn() {
    ...
    const { token, setToken, updateProfile } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$context$2f$auth$2d$context$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAuth"])();
    const { profile } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$context$2f$app$2d$context$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAppContext"])();
    ...
    const handleResendCode = async ()=>{
        ...
        setResendMessage("");
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["sendAuthRequest"])(email);
    ...
    const handleSubmit = async (e)=>{
        ...
        if (step === 1) {
            ...
            try {
                const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["checkLoginCode"])(email, code);
                const newToken = response.data.data.access_token;
                setToken(newToken);
                try {
                    const secretRes = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchBackupSecret"])();
...
//# sourceMappingURL=_67eddaf9._.js.map